...
export default function MainContent() {
  ...
  const handleSend = async () => {
    if (inputMessage.trim() && !isProcessing && datasetLoaded) {
  ...
  const quickActions = [
    { icon: Eye, label: 'View All Data', message: 'Show me all the data', color: 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100' },
    { icon: TrendingUp, label: 'Analyze Trends', message: 'Analyze this dataset for patterns and trends', color: 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100' },
    { icon: BarChart3, label: 'Create Chart', message: 'Visualize this data with a chart', color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100' },
    { icon: Search, label: 'Find Insights', message: 'What are the most interesting insights in this data?', color: 'bg-orange-50 text-orange-700 border-orange-200 hover:bg-orange-100' },
    { icon: Lightbulb, label: 'Get Summary', message: 'Give me a comprehensive summary of this dataset', color: 'bg-yellow-50 text-yellow-700 border-yellow-200 hover:bg-yellow-100' }
  ]
  ...
  const getAnalysisLabel = (analysisType) => {
    const labels = {
  ...
  const getAnalysisColor = (analysisType) => {
    const colors = {
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  {datasetLoaded ? 'Ask questions about your data in natural language' : 'Upload data to start analyzing'}
                </p>
              </div>
                ...
                {messages.map((message, index) => (
                  ...
                  >
                    ...
                    <div className={`max-w-[75%] ${message.type === 'user' ? 'order-1' : ''}`}>
                      ...
                      }`} style={message.type === 'user' ? { backgroundColor: '#8500df' } : {}}>
                        {/* Message Header */}
                          ...
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-3">
                              ...
                              {message.type === 'assistant' && message.analysisType && (
                                <Badge className={`text-xs ${getAnalysisColor(message.analysisType)}`}>
                                  {(() => {
                    ...
                    {message.type === 'user' && (
                      <div className="flex-shrink-0 order-2">
                        <div className="w-10 h-10 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: '#8500df' }}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-xs text-gray-500">
                            ...
                            Processing with complete dataset access
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="p-6">
            <div className="max-w-4xl mx-auto space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    {quickActions.map((action, index) => (
                      <Button
                        ...
                        disabled={!datasetLoaded || isProcessing}
              ...
              <div className="flex gap-4 items-end">
                  ...
                  <Textarea
                    ...
                    placeholder={
                      datasetLoaded 
                        ...
                        : "Upload your dataset first to start analyzing..."
                    }
                    disabled={!datasetLoaded || isProcessing}
                ...
                <Button 
                  onClick={handleSend}
                  disabled={!datasetLoaded || isProcessing || !inputMessage.trim()}
                  size="lg"
              ...
              {datasetLoaded && (
                <div className="text-center">
                  <p className="text-xs text-gray-500">
                    💡 Try: &quot;Create a bar chart&quot;, &quot;Show sales by department&quot;, &quot;Find unusual patterns&quot;, or &quot;Summarize key insights&quot;
                  </p>
                </div>
              )}
            </div>
